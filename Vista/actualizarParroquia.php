...
<head>
    <meta charset="UTF-8">
    <title>Actualizar Parroquia</title>
                        ...
                        ?>
                            ...
                            <form class="" action="../Controladores/controladorParroquia.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="descripcion" value="<?= $row['descripcion'] ?>" onkeypress="return soloLetras(event)" onpaste="return false" maxlength="50">
                                </div>

                                <div class="form-group ">
                                    <label>Latitud</label>
                                    <input class="form-control" type="text" name="latitud" value="<?= $row['latitud'] ?>" onkeypress="return soloNumeros(event)" onpaste="return false" maxlength="11">
                                </div>

                                <div class="form-group ">
                                    <label>Longuitud</label>
                                    <input class="form-control" type="text" name="longuitud" value="<?= $row['longuitud'] ?>" onkeypress="return soloNumeros(event)" onpaste="return false" maxlength="11">
                                </div>
                                ...
                                <a href="ParroquiasAdmin.php" class="btn btn-default">Cancelar</a>
                            </form>
