...
<head>
    <meta charset="UTF-8">
    <title>Actualizar Punto Turísticos</title>
...
$idPunto = $_GET['id'];
$db = Db::conectar();
$select = $db->prepare("SELECT pt.id as id, pt.nombre as nombre, pt.descripcion 
as descripcion, pt.latitud as latitud, pt.longuitud as longuitud, 
pt.creador as creador, pt.costo as costo, pt.costoN as costoN, pt.facebook as facebook, 
pt.twitter as twitter, pt.instagram as instagram, pt.tiempoEstimado 
...
while ($row = $select->fetch(PDO::FETCH_ASSOC)) {
    ...
    $latitud =  $row['latitud'];
    $longuitud =  $row['longuitud'];
    $categoria =  $row['idCategoria'];
    $subCategoria =  $row['subCategoriaId'];
    $costo =  $row['costo'];
    $costoN =  $row['costoN'];
    $facebook =  $row['facebook'];
    $twitter =  $row['twitter'];
    $instagram =  $row['instagram'];
    $parroquia =  $row['idParroquia'];
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Actualizar Puntos Turísticos</h2>
                    </div>
                    <form class="" action="../Controladores/controladorPuntoTuristico.php" method="post" enctype="multipart/form-data">

                        <div class="form-group ">
                            <input type="hidden" class="form-control" type="text" name="id" value="<?= $idPunto ?>" style="display: none">
                        </div>

                        <div class="form-group ">
                            <label>Nombre</label>
                            <input required value="<?= $nombre ?>" class="form-control" type="text" name="nombre" onkeypress="return soloLetras(event)" maxlength="100" placeholder="Ingrese el nombre del Punto Turistico">
                        </div>
                        <div class="form-group ">
                            <label>Descripción</label>
                            <textarea required class="form-control" name="descripcion" rows="10" cols="50" onkeypress="return soloLetrasNumeros(event)" maxlength="900"><?= $descripcion ?></textarea>
                        </div>
                        <div class="form-group ">
                            <label>Latitud</label>
                            <input required value="<?= $latitud ?>" class="form-control" step="any" type="text" name="latitud" placeholder="000.000000" soloNumeros(event)" maxlength="11">
                        </div>
                        <div class="form-group ">
                            <label>Longuitud</label>
                            <input required value="<?= $longuitud ?>" class="form-control" step="any" type="text" name="longuitud" placeholder="000.000000" soloNumeros(event)" maxlength="11">
                        </div>
                        ...
                        <div class="form-group ">
                            <label>Categoría Actual: <?= $categoria ?> </label>
                        ...
                        <div class="form-group">
                            <label>Sub Categoría Actual: <?= $subCategoria ?></label>
                        ...
                        <div class="form-group ">
                            ...
                            <input required value="<?= $costo ?>" class="form-control" step="000.50" type="number" name="costo" placeholder="00.00" onkeypress="return soloNumeros(event)" maxlength="7">
                        </div>

                        <div class="form-group ">
                            <label>Costo Niño</label>
                            <input required value="<?= $costoN ?>" class="form-control" step="000.50" type="number" name="costoN" placeholder="00.00" onkeypress="return soloNumeros(event)" maxlength="7">
                        </div>

                        <div class="form-group">
                            <label>Parroquia Actual: <?= $parroquia ?></label>
                        ...
                        <div class="form-group ">
                            ...
                            <input required value="<?= $tiempoEstimado ?>" class="form-control" type="time" name="tiempoEstimado" VALUE="00:00:00" max="22:30:00" min="00:01:00" step="1" onkeypress="return soloNumeros(event)">
                        </div>

                        <div class="form-group ">
                            <label>Facebook</label>
                            <input value="<?= $facebook ?>"  class="form-control" type="text" name="facebook"  maxlength="200" placeholder="Ingrese el link de Facebook">
                        </div>

                        <div class="form-group ">
                            <label>Twitter</label>
                            <input value="<?= $twitter ?>"  class="form-control" type="text" name="twitter"  maxlength="200" placeholder="Ingrese el link de Twitter">
                        </div>

                        <div class="form-group ">
                            <label>Instagram</label>
                            <input value="<?= $instagram ?>"  class="form-control" type="text" name="instagram"  maxlength="200" placeholder="Ingrese el link de Instagram">
                        </div>
