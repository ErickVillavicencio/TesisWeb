...
<body>
	...
	<div class="form-group">
			...
			<div class="form-group">
				...
				<input required class="form-control" type="text" name="pas" max="15" onkeypress="return soloLetrasyNumeros(event)" onpaste="return false" maxlength="15" placeholder="Ingrese una contraseña">
            </div>
