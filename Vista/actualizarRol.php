                        ...
                        ?>
                            <form class="" action="../Controladores/controladorRol.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="descripcion" value="<?= $row['descripcion'] ?>" onkeypress="return soloLetras(event)" onpaste="return false" maxlength="20">
                                </div>

                                <p>
                                    <input type="hidden" name="actualizar" value="actualizarRol" class="form-control">
