...
<div id="popup" class="overlay">
        <div id="popupBody">
            ...
            <a id="cerrar" href="categoriasAdmin.php">&times;</a>
            ...
            <?php
                        ...
                        ?>
                            <form class="" action="../Controladores/controladorCategorias.php" method="post">
                                ...
                                <div class="form-group ">
                                    <label>De verdad deseea volver a activar la categoría "<?php 
                                ...
                                <p>
                                    ...
                                    <button class=""><a href="categoriasAdmin.php">Cancelar</a></button>                                
                            </form>
                        <?php  } ?>
            </div>
        </div>
