...
<body>
        ...
        <div id="popupBody">
            <h2>Eliminar Rol</h2>
            <a id="cerrar" href="RolesAdmin.php">&times;</a>
            <div class="popupContent">
                ...
                ?>
                    <form class="" action="../Controladores/controladorRol.php" method="post">
                        ...
                        <div class="form-group ">
                            <label>De verdad deseea elimar al Usuario "<?php
                                                                        $nombre = $row['descripcion'];
                                                                        echo ($nombre); ?>"</label>
                        </div>
            </div>
            <p>
                <input type="hidden" name="eliminar" value="eliminarRol" class="form-control">
                <button class="">Eliminar</button>
                <button class=""><a href="RolesAdmin.php">Cancelar</a></button>
                </form>
            <?php  } ?>
        </div>
