...
<html>
<head>
    <title>Activar Subcategoría</title>
...
<div id="popup" class="overlay">
        <div id="popupBody">
            <h2>Activar Sub Categoría</h2>
            <a id="cerrar" href="subCategoriasAdmin.php">&times;</a>
            <div class="popupContent">
            <?php
                        require_once "../ConeccionBD/conexion.php";
                        $db = Db::conectar();
                        $id = $_GET['id'];
                        $select = $db->prepare('SELECT * from subcategoria WHERE id = '.$id.'');
                        $select->execute();
                        ...
                        ?>
                            <form class="" action="../Controladores/controladorSubCategoria.php" method="post">
                                ...
                                <div class="form-group ">
                                    <label>De verdad deseea volver a activar la subcategoría "<?php 
                                ...
                                <p>
                                    ...
                                    <button class=""><a href="subCategoriasAdmin.php">Cancelar</a></button>                                
                            </form>
                        <?php  } ?>
            </div>
        </div>
