...
<head>
  ...
  <link href="Css/crearRuta.css" rel="stylesheet" type="text/css" />
      ...
      <td style="margin-right: 0px;">
        <div class="header">
          <div class="header-right">
            ...
            <a href="crearRuta.php" class="active">Crear Ruta</a>
...
<body>
  ...
  <div class="contenedor">
    ...
    <form action="../Controladores/controladorRuta.php" method="post" class="form-container">
      <h1>Nueva Ruta</h1>

      <div class="form-group ">
        <label>Nombre</label>
        <input required class="form-control" type="text" name="nombre" onkeypress="return soloLetrasNumeros(event)" onpaste="return false" maxlength="20" placeholder="Ingrese el nombre de la ruta">
      </div>

      <div class="form-group ">
        <label>Fecha Inicio</label>
        <input required class="form-control" step="any" type="date" name="fecha" min="<?php echo date("Y-m-d"); ?>">
      </div>

      <div class="form-group ">
        <label>Hora Inicio</label>
        <input required class="form-control" step="any" type="time" name="horaInicio" min="10:00" max="15:00">
      </div>

      <div class="form-group ">
        <label>Número de Adultos</label>
        <input required class="form-control" step="any" type="number" name="numeroAdultos" min="0" max="99">
      </div>

      <div class="form-group ">
        <label>Número de Niños</label>
        <input required class="form-control" step="any" type="number" name="numeroNinios" min="0" max="99">
      </div>

      <div>
        <input name="idUsuario" type="text" value="<?php echo $idUsuario; ?>" style="visibility:hidden" name="creador">
      </div>
