                ...
                <div class="col-md-12">
                    ...
                    <form class="" action="../Controladores/controladorParroquia.php" method="post">
                        ...
                        <div class="form-group ">
                            ...
                            <input required class="form-control" type="text" name="descripcion" onkeypress="return soloLetras(event)" maxlength="50" placeholder="Ingrese el nombre de la Parroquia">
                        </div>
                        <div class="form-group ">
                            <label>Latitud</label>
                            <input required class="form-control" step="any" type="text" name="latitud" placeholder="000.000000" onkeypress="return soloNumeros(event)" maxlength="11">
                        </div>
                        <div class="form-group ">
                            <label>Longuitud</label>
                            <input required class="form-control" step="any" type="text" name="longuitud" placeholder="000.000000" onkeypress="return soloNumeros(event)" maxlength="11">
                        </div>
