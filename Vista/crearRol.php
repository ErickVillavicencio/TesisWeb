        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="" action="../Controladores/controladorRol.php" method="post">
                        <div class="form-group ">
                            <label>Descripción</label>
                            <input required class="form-control" type="text" name="descripcion" onkeypress="return soloLetras(event)" onpaste="return false" maxlength="20" placeholder="Ingrese el nombre del Rol">
                        </div>
                        <p>
                            <input  type="hidden" name="registrar" value="registrarRol" class="form-control">
                            <button class="btn btn-default">Registrar</button>
                        </p>
                        <a href="RolesAdmin.php" class="btn btn-default">Cancelar</a>
                    </form>
                </div>
            </div>
        </div>
