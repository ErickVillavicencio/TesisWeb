                ...
                <div class="col-md-12">
                    ...
                    <form class="" action="../Controladores/controladorSubCategoria.php" method="post">
                        ...
                        <div class="form-group ">
                            ...
                            <input class="form-control" type="text" name="descripcion" onkeypress="return soloLetras(event)" maxlength="200" placeholder="Ingrese el nombre de la sub Categoría">
                        </div>
                        <p>
