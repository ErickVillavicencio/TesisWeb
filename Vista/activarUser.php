...
<div id="popup" class="overlay">
        <div id="popupBody">
            ...
            <a id="cerrar" href="UsuariosAdmin.php">&times;</a>
            ...
            <?php
                        ...
                        ?>
                            <form class="" action="../Controladores/controladorUser.php" method="post">
                                ...
                                <div class="form-group ">
                                    <label>De verdad deseea volver a Activar al Usuario "<?php 
                                    $nombre = $row['nombres'];
                                    echo($nombre); ?>"</label>
                                </div>                               
                                </div>
                                <p>
                                    ...
                                    <button class=""><a href="UsuariosAdmin.php">Cancelar</a></button>                                
                            </form>
                        <?php  } ?>
            </div>
        </div>
